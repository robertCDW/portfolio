...
const About = () => {
  return (
    <div id={'about'} className={styles.about} style={{ padding: '2rem 1rem'}}>
      ...
      <h1>Robert Scales is a full stack developer who recently graduated from web bootcamp.</h1>
      <h1>He has 3 years of experience in network engineering utilizing automation and scripting.</h1>
    </div>
  )
}
